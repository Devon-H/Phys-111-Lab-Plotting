...
axs.set_title("Frequency vs. n (L = 109cm)")
axs.set_xlabel('n')
axs.set_ylabel('Frequency [Hz]')

axs.grid(which = 'major', color='black', linestyle='-.', linewidth=0.25)

axs.plot(n5, Run5,'.', label="Run 5 (4.905N)", color="blue")
axs.plot(n6,Run6, '.', label = "Run 6 (2.943N)", color = "red")
axs.plot(n7,Run7, '.', label = "Run 7 (0.981N)", color = "green")
